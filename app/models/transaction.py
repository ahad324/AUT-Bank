...
class Transaction(Base):
    ...
    TransactionType = Column(String(20), nullable=False)  # Constraint enforced in schema
    ReferenceNumber = Column(String(50), nullable=True)
    Status = Column(String(20), server_default='Pending')  # Constraint enforced in schema
