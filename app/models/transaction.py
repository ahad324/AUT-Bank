from sqlalchemy import CheckConstraint, Column, Integer, String, DateTime, DECIMAL, ForeignKey, Enum as SQLEnum
...
class Transaction(Base):
    ...
    Amount = Column(DECIMAL(19,4), CheckConstraint("Amount > 0"), nullable=False)
