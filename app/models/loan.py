...
class Loan(Base):
    ...
    MonthlyInstallment = Column(DECIMAL(19,4), nullable=False)
...
class LoanPayment(Base):
    ...
    PaymentDate = Column(Date, server_default=func.now())
    LateFee = Column(DECIMAL(10,2), server_default=text('0'))
    TotalAmountPaid = Column(DECIMAL(19,4), nullable=False)